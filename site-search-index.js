(function () {
  ...
  window.SEARCH_INDEX = [
    ...
    { page: 'finances', title: 'Paying tuition and reading your invoice', anchor: '#tuition-deferral', keywords: 'ACORN invoice minimum payment register deferral government aid fall winter subtotal session total', snippet: 'Choose the payment pathway that applies to you and open an annotated Fall, Winter and full-session invoice example.' },

    { page: 'academics', title: 'Before O-Week', anchor: '#before-oweek', keywords: 'before oweek pre study summer prepare academics incoming', snippet: 'You do not need to study before medical school. A short overview is available if you are curious; the full guide can wait until O-Week.' },
